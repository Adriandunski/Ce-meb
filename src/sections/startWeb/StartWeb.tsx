...
export default function StartWeb() {
    ...
    return (
        <div className={'flex lg:flex-row flex-col bg-[#F7F2ED] py-32 xl:px-36 px-16 gap-10'}>
            <div className={'basis-1/2 shrink-0 flex flex-col justify-between gap-10'}>
            ...
            <div className={'basis-1/2 shrink-0 relative overflow-hidden rounded-sm'}>
                <Image src={'/renowacje/tapicerstwo1.jpg'} alt={'Tapicerstwo'} fill objectFit={'cover'}/>
            </div>
        </div>
