    ...
    return(
        <ContainerWeb idStr={'aboutUs'}>
            <div className={'flex flex-col-reverse gap-16 lg:flex-row'}>
                <div className={'md:basis-1/2 relative flex justify-center items-center lg:h-auto h-96 rounded-md overflow-hidden'}>
                    ...
                    <div className={'flex flex-col gap-10 justify-center'}>
                        <div className={'flex flex-col gap-3'}>
                            ...
                            <div className={'flex flex-col gap-5'}>
                                <p className={'text-5xl font-Jost font-bold md:text-left text-center'}>Zalety Wyboru <span
                                    className={'text-gold'}>Naszej</span> Firmy</p>
                                <p className={'font-light text-base text-neutral-600 font-Roboto'}>Jesteśmy małym zakładem
